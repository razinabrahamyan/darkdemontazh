                                    ...
                                    <td>
                                        <div class="input-group">
                                            <textarea
                                                ...
                                                name="description"
                                                v-bind:value="setPrices[{{$price->id}}+'_description'] = '{{$price->description ?? null}}'"
                                                v-on:input="setPrices[{{$price->id}}+'_description'] = $event.target.value"
                                            ></textarea>
                                    ...
                                    <td>
                                        <div class="">
                                            <button
                                                ...
                                                data-id="{{$price->id}}"
                                                @click="submit($event, '{{$price->id}}', '{{route('admin.chermet.change', $price->id)}}')"
                                            >
                                                Сохранить
                                            </button>
                                        </div>
            ...
            methods: {
                submit : function(e, id, route) {
                    ...
                    const payload = {
                        ...
                        description: this.setPrices[dataId + '_description'],
